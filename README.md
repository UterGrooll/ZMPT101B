...
- Примеры использования в папке [`examples/`](examples/)
- Схема подключения в папке [`schematics/`](schematics)
...
Откройте поочередно примеры из папки [`examples/`](examples/)
...
🔌 Подключение датчика ZMPT101B
  Схема подключения [`schematics/`](schematics)
